...
(* ----- Побудова модуля сортування вставками списків натуральних чисел ----- *)
...
(* -------- Побудова модуля сортування вставками списків чисел (тип Z)------- *)
(* Наведіть нижче відповідний текст, аналогічний випадку натуральних чисел.   *)
(* Визначення типу і необхідні леми шукай в стандартній бібліотеці Coq.ZArith *)
