...
Проте ми почнемо з загальної концерії універсумів типів в The Coq Proof Assistant.
...
Як і в наївній теорії множин, ми могли б бажати існування всесвіту всіх типів $\mathcal{U}_\infty$, включаючи себе самого
(тобто $\mathcal{U}_\infty:\mathcal{U}_\infty$).
