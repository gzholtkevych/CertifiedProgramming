...
- збій (fault) - нездатність виконувати необхідні дії через внутрішній стан;
- відмова (failure) - втрата здатності виконувати необхідні дії;
- помилка (error) - розбіжність між обчисленим, спостережуваним або виміряним значенням або умовою та очикуваним (справжнім) значенням, заданим або теоретично передбачуваним значенням або умовою.
...
Основна об'єктивна проблема цього підходу пов'язана з теоремою Райса, яка стверджує, що для повних за Тьюрингом систем програмування, будь-яка властивість синтаксично-правильних програм є алгоритмічно нерозв'язною.

Технічною (суб'єктивною) проблемою цього підходу є високий математичний рівень входження в проблематику, що суттєво звужує коло фахівців, які можуть його використовувати.

Цей курс знайомить слухачів з сертифікованим програмуванням, що базується на використанні комплексу програмних інструментів, відомих як [The Coq Proof Assistant](https://coq.inria.fr/).
...
Типові програми включають сертифікацію властивостей мов програмування (наприклад, проект сертифікації компілятора CompCert, Verified Software Toolchain для перевірки програм C або фреймворк Iris для логіки паралельного розділення), формалізацію математики (наприклад, повну формалізацію теореми Фієта-Томпсона, або теорії гомотопічних типів).
