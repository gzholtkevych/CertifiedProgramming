...
Для програмного забезпечення критичною загрозою є помилка в програмному коді, яка може викликати напрогнозовану поведенку системи в цілому.
Помилку в програмному коді можна визначити як розбіжність між фактичними властивостями поведінки розробленого програмного коду і заявленими у специфікації вимог властивостями поведінки програмного коду.

Забезпечення надійності (dependability), таким чином, передбачає комплекс захдів щодо встановлення істинності судження ``*програмний код відповідає властивостям, що зафіксовані у специфікації вимог*''.
