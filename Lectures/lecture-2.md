...
> - існує скінченна послідовність бута-редукцій та ета-конверсій, яка перетворює $M$ на $N$.

**Теорема Черча-Росера**
>Для будь-яких двох термів $M_1$ та $M_2$ існує терм $N$ такий, що $M_1$ редукується до $N$ і $M_2$ редукується до $N$.
