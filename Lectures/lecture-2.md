...
Судженням типізації є вираз виду $\displaystyle \Gamma \vdash M:\alpha $, де $\displaystyle \Gamma $ є контекстом, $\displaystyle M$ - термом, а $\displaystyle \alpha $ - типом, яке читається як "в контексті $\displaystyle \Gamma $ терм $\displaystyle M$ населяє (має) тип $\displaystyle \alpha $".
